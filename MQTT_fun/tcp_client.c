...
#include "task.h"
  ...
  uint8 mqtt_server_ip[4] = {101,133,196,128};			// 配置远程服务器IP地址
...
/**************************/
	...
	char topic[100]={"/a1ZCY7ACE5k/FY-STM32/user/get"};//{"/TKKMt4nMF8U/MQTT1/mqtt"};//设置发布订阅主题
	char new_topic[100];
	int count=0;
	char rebuf[1024];
	void hamacsha1(void);
...
//					make_con_msg("1234|securemode=3,signmethod=hmacsha1|",180	, 1,
//					"FY-STM32&a1ZCY7ACE5k","CD22A5844A0721998804B5EC6916DB96FE683180",msgbuf,sizeof(msgbuf));
					make_con_msg("12345|securemode=3,signmethod=hmacsha1|",180	, 1,
						"FY-STM32&a1ZCY7ACE5k","111a035af5cfedc922fa62fdff835e2294e49625",msgbuf,sizeof(msgbuf));	
